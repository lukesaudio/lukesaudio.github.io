...
{
  console.log("Original note: " + noteToQuantize + "\n");
  let quantizeToC = quantizeNoteToCMajor(noteToQuantize);

  console.log("After C Quantize note: " + quantizeToC + "\n");

  let quantizeToScale = applyModeToNote(quantizeToC, scaleToQuantzie);
  //console.log("After Scale Quantize note: " + quantizeToScale + "\n");

  let finalNote = transposeToKey(quantizeToScale, keySignatureToUse);
  //console.log("After Transposition note: " + finalNote + "\n");
...
function applyModeToNote(noteToMode, desiredScalePitchClass)
  {
    ...
    //console.log("Incoming note: " + noteToMode + "\n");
    //console.log("Pitch class of incoming note: " + pitch + "\n");

    let positionInArray = musicalScalesPitchClasses.major.indexOf(pitch);
    //console.log("Position in array: " + positionInArray + "\n")
    ...
    console.log("Old Pitch Class: " + indexOfOldPitchClass + "\n");
    console.log("New Pitch Class: " + indexOfNewPitchClass + "\n");


    let modifier = indexOfNewPitchClass - indexOfOldPitchClass;

    console.log("Change note by: " + modifier);
